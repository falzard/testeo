...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        {
            if(player->GetTeamId() == TEAM_ALLIANCE)
                player->ADD_GOSSIP_ITEM(0, "El Arcanista Tybalin me dijo que podrías prestarme un tabardo.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
            else
                player->ADD_GOSSIP_ITEM(0, "El Magister Hathorel dijo que podrías prestarme un tabardo.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
        }
