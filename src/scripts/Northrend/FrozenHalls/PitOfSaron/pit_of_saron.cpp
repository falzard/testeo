...
"Te debo una larga noche de beber, amigo mío.",
"No dejes a ninguno de ellos con vida.",
"Apenas puedo sentir mis brazos, pero estaré contigo una vez que encuentre algunas armas.",
"No puedo creer lo que veo. Gracias. De verdad gracias.",
"Te debo la vida.",
"Pensé que moriría en este pozo. ¡Gracias!",
"Encontraré una manera de pagarte algún día, héroe.",
"Casi había perdido la esperanza.",
"Había perdido la noción del tiempo en este lugar abandonado. Eres una visión para mis doloridos ojos, amigo.",
"Lucharé a tu lado. No les des piedad.",
"Me reuniré contigo en cuanto me recupere el aliento, héroes. Gracias.",
"Voy a volver a ayudar a liberar al resto de los esclavos. Gracias de nuevo, héroe.",
"Voy a volver al frente de la cantera. Mata a algunos más para mí.",
"Me alegra que estés aquí. No habría aguantado mucho más.",
"Estoy contigo, héroe.",
"Si con mi vida o con mi muerte puedo pagarte, ¡así será!",
"¡Es hora de nuestra venganza!",
"Porfavor, ejecuta nuestra venganza sobre el Señor de la Plaga.",
"Demasiados de nosotros murieron en este pozo. Demasiados.",
"Cuando mates al Señor del Foso, escupe en su cadáver por mí, ¿quieres?",
"Eres una hermosa visión ... no tienes ni idea.",
"Ten a mis bebés.",
"¡Solo podría besarte!"
};
